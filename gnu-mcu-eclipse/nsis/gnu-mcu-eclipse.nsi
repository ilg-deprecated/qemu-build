...
File "${INSTALL_FOLDER}\gnu-mcu-eclipse\build-${PRODUCTLOWERCASE}.sh"
File "${INSTALL_FOLDER}\gnu-mcu-eclipse\BUILD.txt"
File "${INSTALL_FOLDER}\gnu-mcu-eclipse\CHANGES.txt"
