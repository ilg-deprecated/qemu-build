    ...
    (
      ...
      (
        ...
        then
          ...
          install -d -m 0755 "${INSTALL_FOLDER_PATH}"/lib
          install -m644 -t "${INSTALL_FOLDER_PATH}"/lib libz.dll.a
          install -d -m 0755 "${INSTALL_FOLDER_PATH}"/bin
          install -m755 -t "${INSTALL_FOLDER_PATH}"/bin zlib1.dll
        fi
...
function do_libpng() 
{
  ...
  then
    ...
    (
      mkdir -p "${BUILD_FOLDER_PATH}/${LIBPNG_FOLDER_NAME}"
      cd "${BUILD_FOLDER_PATH}/${LIBPNG_FOLDER_NAME}"
      ...
      then 
        ...
        (
          ...
          bash "${WORK_FOLDER_PATH}/${LIBPNG_SRC_FOLDER_NAME}/configure" \
            --prefix="${INSTALL_FOLDER_PATH}" \
            \
            --build=${BUILD} \
            --host=${HOST} \
...
function do_jpeg() 
{
  ...
  then
    ...
    (
      mkdir -p "${BUILD_FOLDER_PATH}/${JPEG_FOLDER_NAME}"
      cd "${BUILD_FOLDER_PATH}/${JPEG_FOLDER_NAME}"
...
function do_sdl2() 
{
  ...
  then
    ...
    (
      mkdir -p "${BUILD_FOLDER_PATH}/${SDL2_FOLDER_NAME}"
      cd "${BUILD_FOLDER_PATH}/${SDL2_FOLDER_NAME}"
      ...
      then 
        ...
        (
          ...
          bash "${WORK_FOLDER_PATH}/${SDL2_SRC_FOLDER_NAME}/configure" \
            --prefix="${INSTALL_FOLDER_PATH}" \
            \
            --build=${BUILD} \
            --host=${HOST} \
...
function do_sdl2_image() 
{
  ...
  then
    ...
    (
      mkdir -p "${BUILD_FOLDER_PATH}/${SDL2_IMAGE_FOLDER_NAME}"
      cd "${BUILD_FOLDER_PATH}/${SDL2_IMAGE_FOLDER_NAME}"
      ...
      then 
        ...
        (
          ...
          bash "${WORK_FOLDER_PATH}/${SDL2_IMAGE_SRC_FOLDER_NAME}/configure" \
            --prefix="${INSTALL_FOLDER_PATH}" \
            \
            --build=${BUILD} \
            --host=${HOST} \
    ...
    (
      ...
      then 
        ...
        (
          ...
          bash "${WORK_FOLDER_PATH}/${GETTEXT_SRC_FOLDER_NAME}/gettext-runtime/configure" \
            --prefix="${INSTALL_FOLDER_PATH}" \
            \
            --build=${BUILD} \
            --host=${HOST} \
...
function do_glib() 
{
  ...
  then
    ...
    (
      ...
      mkdir -p "${BUILD_FOLDER_PATH}/${GLIB_FOLDER_NAME}"/gio/lib
      cd "${BUILD_FOLDER_PATH}/${GLIB_FOLDER_NAME}"
      ...
      then 
        ...
        (
          ...
          bash "${WORK_FOLDER_PATH}/${GLIB_SRC_FOLDER_NAME}/configure" \
            --prefix="${INSTALL_FOLDER_PATH}" \
            \
            --build=${BUILD} \
            --host=${HOST} \
...
function do_pixman() 
{
  ...
  then
    ...
    (
      mkdir -p "${BUILD_FOLDER_PATH}/${PIXMAN_FOLDER_NAME}"
      cd "${BUILD_FOLDER_PATH}/${PIXMAN_FOLDER_NAME}"
      ...
      then 
        ...
        (
          ...
          # --enable-shared
          bash "${WORK_FOLDER_PATH}/${PIXMAN_SRC_FOLDER_NAME}/configure" \
            --prefix="${INSTALL_FOLDER_PATH}" \
            \
            --build=${BUILD} \
            --host=${HOST} \
...
function do_libxml2() 
{
  ...
  then
    ...
    if [ ! -d "${BUILD_FOLDER_PATH}/${LIBXML2_FOLDER_NAME}" ]
    then
      (
        cp -r "${LIBXML2_SRC_FOLDER_NAME}" \
          "${BUILD_FOLDER_PATH}/${LIBXML2_FOLDER_NAME}"

        cd "${BUILD_FOLDER_PATH}/${LIBXML2_FOLDER_NAME}"
        xbb_activate
    ...
    (
      ...
      mkdir -p "${BUILD_FOLDER_PATH}/${LIBXML2_FOLDER_NAME}"/lib
      cd "${BUILD_FOLDER_PATH}/${LIBXML2_FOLDER_NAME}"
